...
<?php
	...
	{
?>
		<form  name="board_form" method="post" action="insert.php?mode=modify&num=<?php echo $num?>&page=<?php echo $page?>&table=<?php echo $table?>">
<?php
	}
	elseif ($mode=="response")
	{
?>
		<form  name="board_form" method="post" action="insert.php?mode=response&num=<?php echo $num?>&page=<?php echo $page?>&table=<?php echo $table?>">
<?php
	}
	else
	{
?>
		<form  name="board_form" method="post" action="insert.php?table=<?php echo $table?>">
<?php
	}
?>
		<div id="write_form">
			...
			<div id="write_row1">
				...
				<div class="col2"><?php echo $usernick?></div>
<?php
