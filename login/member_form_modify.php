...
?>
	...
	<div id="col2">
		...
		<div id="form_join">
			...
			<li><input type="password" name="pass_confirm" value="<?php echo $row['pass'] ?>"></li>
			...
			<li><input type="text" class="hp" name="hp1" value="<?php echo $hp1 ?>"> 
             - <input type="text" class="hp" name="hp2" value="<?php echo $hp2 ?>"> - <input type="text" class="hp" name="hp3" value="<?php echo $hp3 ?>"></li>
			<li><input type="text" id="email1" name="email1" value="<?php echo $email1 ?>"> @ <input type="text" name="email2" 
			           value="<?php echo $email2 ?>"></li>
			</ul>
			</div>
			<div class="clear"></div>
