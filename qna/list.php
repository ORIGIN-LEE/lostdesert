...
?>
			<div id="list_item">
				...
				<div id="list_item2"><?php echo $space?><a href="view.php?table=<?php echo $table?>&num=<?php echo $item_num?>&page=<?php echo $page?>"><?php echo  $item_subject ?></a></div>
