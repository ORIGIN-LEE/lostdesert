	...
	<div id="col2">        
		...
		<div id="list_top_title">
			<ul>
				...
				<li id="list_title2_1"><img src="../img/list_title2.gif"></li>
				<li id="list_title3"><img src="../img/list_title3.gif"></li>
				<li id="list_title4"><img src="../img/list_title4.gif"></li>
				<li id="list_title5"><img src="../img/list_title6.jpg"></li>
			</ul>		
		</div>
...
?>
			<div id="list_item">
				...
				<div id="list_item2_1"><a href="view.php?num=<?php echo $item_num?>&page=<?php echo $page?>"><?php echo  $item_subject ?></a>
<?php
		if ($num_ripple)
				echo "[$num_ripple]";
?>
